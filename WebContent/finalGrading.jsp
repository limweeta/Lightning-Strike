	...
	<body>
		<div id="content-container">
			<div id="content">
				...
				<div class="span8">
					<form class="form-horizontal" method="post" name="finalGrading">

						<!-- Form Name -->
						<legend>FYP Final Grading</legend>
						...
						<div class="control-group">
						  <label class="control-label" for="grader">Grader</label>
						  <div class="controls">
						    <input id="grader" name="grader" type="text" placeholder="Grader" class="input-large" >
